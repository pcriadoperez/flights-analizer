...
class Dashboard extends React.Component{
    render(){
      ...
      console.log(this.citiesArray)
        ...
        <DashboardCard title="CO2: " data={Math.round(km*co2perkm/1000)} unit="tons" width={412} color='#FFCB23'>
        <a href='https://www.terrapass.com/product/productindividuals-families' >Offset your Carbon Footprint</a>
          ...
          <DashboardCard title="Around the world: " data={Math.round(km/40074)} unit="times"  width={412}/>
          ...
          <DashboardCard title="Countries visited" data={Object.keys(countries).length} unit="countries"/>
          <DashboardCard title="Cities visited" data={Object.keys(cities).length} unit="cities"/>
          <DashboardCard title="Most visited" color='#4C9FFE' data={Object.keys(cities).reduce((a, b) => cities[a] > cities[b] ? a : b)} unit="" corlor='#FFCB23'/>
