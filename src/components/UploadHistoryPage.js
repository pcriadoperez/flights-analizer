  ...
  _handleNameChange = event => {
    ...
    if (value !== "") {
      ...
      fire
        ...
        .then(query => {
          if (query.size === 0) {
            if (query.query._query.path.segments[0] === this.state.name)
              this.setState({ error: false, loading: false });
          } else if (query.query._query.path.segments[0] === this.state.name)
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <h3 style={{ color: "#4C9FFE" }}>
                <span style={{ color: "black" }}>1.</span> Download your
                Location History from Google. Here is an image to help how
              </h3>
          <a
...
{" "}
          ...
          <Grid className={classes.sideMenu} item xs={12} sm={6}>
              ...
              This will create a unique link for
              WhereHaveYouBeenInTheWorld.com/YourMap
            </h5>
              <CssTextField
              id="custom-css-standard-input" required error={this.state.error} label="Name your map"
              helperText={
                this.state.error
                  ? "Name is already taken"
                  : `https://wherehaveIbeenintheworld.com/${this.state.name}`
              }
            ...
            />
              ...
              onDataChange={d => this.setState({ trips: d })}
              onDone={e =>
            ...
            />
              ...
              <h5>
              Don't worry we value your privacy and won't share this information
              with anyone. Also you can delete it anytime
            </h5>
            </Grid>
        </Grid>
        <Grid
        ...
        >
          <div style={{ margin: 5 }}>
            ...
            hi@wherehaveIbeenintheworld.com
          </div>
          <div style={{ margin: 5 }}>
            If you like the map and want to show some love, you can show support
            by buying me a coffee
          </div>
          <a
            className="bmc-button"
            target="_blank"
            href="https://www.buymeacoffee.com/pablito">
            <img
